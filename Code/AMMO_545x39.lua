...
function GBO_545x39()
	...
	_5_45x39_Basic.AdditionalHint = T({"<bullet_point> Tumbling effects increase Critical Chance"})
	...
	_5_45x39_Tracer.AppliedEffects = {"Marked", "Revealed_R"}
	...
	_5_45x39_HP.AppliedEffects = {"Bleeding"}
