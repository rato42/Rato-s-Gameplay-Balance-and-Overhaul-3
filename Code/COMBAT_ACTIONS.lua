function rat_combat_actions()
	...
	CombatActions.DualShot.GetAPCost = function(self, unit, args)
		...
		return Max(unit:GetAttackAPCost(self, weapon1, weapon1.ShootAP, aim, ap1),
		           unit:GetAttackAPCost(self, weapon2, weapon2.ShootAP, aim, ap2)) + ap_extra + twohand_cost + cycling_total
	...
	CombatActions.Overwatch.GetActionDescription = function(self, units, args)
		local unit = units[1]
		local apply, value = Presets.ChanceToHitModifier.Default.OpportunityAttack:CalcValue(unit, nil, nil, nil, nil, nil,
		                                                                                     nil, nil, true)
