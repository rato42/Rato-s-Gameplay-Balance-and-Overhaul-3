-- function rat_compatibility_SO()

	-- function MGSetup_fix()
		-- print("return")
		-- return
	-- end
...
function OnMsg.EnterSector()
	...
	-- end
	if IsMod_loaded("Msdfsds3") and not already_placed then
...
function smart_xtempl()
	...
	xt1[1][1].OnPress = function(self, gamepad)
						...
						local SO_BodyPart_rotation = {Auto = "head",
						head = "hand",
						hand='torso',
						torso='groin',
						groin='leg',
						...
						local function SO_get_next_attack(weapon_attacks, cur_attack)
							...
							if cur_attack then
								...
								ind=ind+1
								if ind>#SO_attacks then ind=1	end
							else 
								ind =1
							end
