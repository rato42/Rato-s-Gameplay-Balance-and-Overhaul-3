...
function weapon_components_rat()
	...
	PlaceObj('WeaponComponentEffect', {
		Description = T(388838149410, "Reduced <em>recoil penalty</em>. Reduced <em>Hipfire</em> and <em>Snapshot</em> penalty"),
		group = "FX Placeholders",
		id = "Vert_grip_recoil",
	})
	...
	PlaceObj('WeaponComponentEffect', {
		...
		Parameters = {
			PlaceObj('PresetParamNumber', {
				'Name', "OverwatchAngleFlat",
				'Tag', "<OverwatchAngleFlat>",
			}),
		},
		RequiredParams = {
			"OverwatchAngleFlat",
	...
	PlaceObj('WeaponComponentEffect', {
		Description = T(915008271800, "Decreased Hipfire penalty, increased Snapshot penalty, reduced Recoil penalty, decreases Point Blank range accuracy, harder to hit at melee range"),
		group = "ChanceToHit",
		id = "longbarrel",
	})

	PlaceObj('WeaponComponentEffect', {
		Description = T(173836158177, "Increased Hipfire penalty, increased Snapshot penalty, increased Recoil penalty, increases Point Blank range accuracy, easier to hit at melee range"),
		group = "ChanceToHit",
		id = "shortbarrel",
	})
	...
	PlaceObj('WeaponComponentEffect', {
		Description = T(176134897607, --[[WeaponComponentEffect ReduceDamage Description]] "Damaged reduced by <DamageReduced>"),
		ModificationType = "Subtract",
		Parameters = {
			PlaceObj('PresetParamNumber', {
				'Name', "DamageReduced",
		...
		PlaceObj('WeaponComponentEffect', {
		Description = T(985718079927, --[[WeaponComponentEffect ReduceDamage Description]] "Damaged reduced by <DamageReducedMul>%"),
		ModificationType = "Multiply",
		Parameters = {
			PlaceObj('PresetParamNumber', {
				'Name', "DamageReducedMul",
				'Value', 100,
				'Tag', "<DamageReducedMul>",
			}),
		},
		RequiredParams = {
			"DamageReducedMul",
		...
		id = "Reduce_recoil_burst_delta",
			...
			PlaceObj('WeaponComponentEffect', {
		Description = T(531446098401, --[[WeaponComponentEffect ReduceDamage Description]] "Damaged increased by <DamageIncreasedMul>%"),
		ModificationType = "Multiply",
		Parameters = {
			PlaceObj('PresetParamNumber', {
				'Name', "DamageIncreasedMul",
				'Value', 100,
				'Tag', "<DamageIncreasedMul>",
			}),
		},
		RequiredParams = {
			"DamageIncreasedMul",
	...
	PlaceObj('WeaponComponentEffect', {
		...
		Parameters = {
			PlaceObj('PresetParamNumber', {
				'Name', "CritChangeScaledDecrease",
				'Tag', "<CritChangeScaledDecrease>",
			}),
		},
		RequiredParams = {
			"CritChangeScaledDecrease",
		},
	...
	PlaceObj('WeaponComponentEffect', {
		...
		Parameters = {
			PlaceObj('PresetParamNumber', {
				'Name', "CritChangeDecrease",
				'Tag', "<CritChangeDecrease>",
			}),
		},
		RequiredParams = {
			"CritChangeDecrease",
	...
	PlaceObj('WeaponComponentEffect', {
		Description = T(954822518050, "Sligthly reduced <em>recoil penalty</em>"),
		group = "FX Placeholders",
	...
	PlaceObj('WeaponComponentEffect', {
		Description = T(776447188724, "Sligthly reduced <em>recoil penalty</em>"),
		group = "FX Placeholders",
	...
	PlaceObj('WeaponComponentEffect', {
		Description = T(796931242458, "Significantly reduced penalty to <em>target body parts</em> with attacks with 4+ aim levels"),
		group = "FX Placeholders",
		id = "bodypart_scope",
	})
	...
	PlaceObj('WeaponComponentEffect', {
		Description = T(353562872144, "Grants bonus Accuracy to attacks with 3+ aim levels - bonus is based on <em>Weapon Aim Accuracy</em>"),
		group = "FX Placeholders",
		id = "sniper_aim_scope",
	})

	PlaceObj('WeaponComponentEffect', {
		Description = T(213711882780, "Grants significant bonus Accuracy to attacks with 4+ aim levels - bonus is based on <em>Weapon Aim Accuracy</em>"),
		group = "FX Placeholders",
		id = "sniper_adv_aim_scope",
	})

	PlaceObj('WeaponComponentEffect', {
		Description = T(247212055308, "Grants bonus Accuracy to attacks with 2+ aim levels - bonus is based on <em>Weapon Aim Accuracy</em>"),
		group = "FX Placeholders",
	...
	PlaceObj('WeaponComponentEffect', {
		Description = T(949818133594, "Light Barrel, reduced <em>Snapshot</em> accuracy <em>penalty</em>, increased <em>Recoil</em> penalty"),
		group = "FX Placeholders",
	...
	PlaceObj('WeaponComponentEffect', {
		Description = T(983043466921, "Heavy Barrel, reduced <em>Recoil</em> penalty, increased <em>Snapshot</em> accuracy <em>penalty</em>"),
		group = "FX Placeholders",
	...
	PlaceObj('WeaponComponentEffect', {
		Description = T(982346640578, "Sligthly reduced <em>recoil penalty</em>"),
		group = "FX Placeholders",
		id = "tac_grip_recoil",
	})
	...
	PlaceObj('WeaponComponentEffect', {
		Description = T(952508575329, "Sligthly increased Point-Blank range accuracy bonus"),
		group = "FX Placeholders",
		id = "tac_grip_PB",
	})
	...
	PlaceObj('WeaponComponentEffect', {
		Description = T(695581761922, "After firing, needs to be manually cycled using <ap_manual> AP\nHigh <em>Dexterity</em> can reduce this cost"),
		Parameters = {
			PlaceObj('PresetParamNumber', {
				'Name', "ap_manual",
				'Value', 3,
		...
		PlaceObj('WeaponComponentEffect', {
		Description = T(646661766533, "After firing, increases attack AP cost by <ap_double_action>\nCan be manually cycled using <ap_manual> AP\nHigh <em>Dexterity</em> can reduce this cost"),
		Parameters = {
			PlaceObj('PresetParamNumber', {
				'Name', "ap_manual",
				'Value', 3,
	...
	PlaceObj('WeaponComponentEffect', {
		Description = T(212821718310, "Increase Stance AP cost by <StanceIncreaseSTR>, can be negated with <STR_threshold> Strength"),
		Parameters = {
			PlaceObj('PresetParamNumber', {
	...
	PlaceObj('WeaponComponentEffect', {
	Description = T(236633317127, "Decreases weapon length, affecting Recoil, Snapshot, Hipfire accuracy penalties and Point Blank Range accuracy modifiers"),
		Parameters = {
		PlaceObj('PresetParamPercent', {
			'Name', "recoil_mul",
			'Value', 100,
	...
	PlaceObj('WeaponComponentEffect', {
	Description = T(219179226706, "Increases weapon length, affecting Recoil, Snapshot, Hipfire accuracy penalties and Point Blank Range accuracy modifiers"),
		Parameters = {
		PlaceObj('PresetParamPercent', {
			'Name', "recoil_mul",
			'Value', 100,
...
[954822518050] = 'Sligthly reduced <em>recoil penalty</em>',
[598891097935] = 'Reduced <em>recoil penalty</em>',
[743623158693] = 'Reduced <em>recoil penalty</em>',
[776447188724] = 'Sligthly reduced <em>recoil penalty</em>',
...
[982346640578] = 'Sligthly reduced <em>recoil penalty</em>',
[845256852079] = 'Reduced <em>Hipfire and Snapshot penalty</em>',
[952508575329] = 'Sligthly increased Point-Blank range accuracy bonus',
