function ow_cth()
	...
	Presets.ChanceToHitModifier.Default["OpportunityAttack"].CalcValue = function (self, attacker, target, body_part_def, action, weapon1, weapon2, lof, aim, opportunity_attack, attacker_pos, target_pos)	
		...
		--print("bonus value ow", value, "scale factor", scale_factor)
