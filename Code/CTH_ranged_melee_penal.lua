function place_ranged_melee_CTH()
    PlaceObj('ChanceToHitModifier', {
        CalcValue = function(self, attacker, target, body_part_def, action, weapon1, weapon2, lof,
            ...
            local target_pos = target_pos or (IsValid(target) and target:GetPos())
        ...
        display_name = T(351472500288, --[[ChanceToHitModifier Default RangedMeleePenal display_name]]
                         "Firing at Melee Range"),
        group = "Default",
        id = "RangedMeleePenal"
    })
