function rat_format_hints(self)
  ...
  {TranslationTable[651371401489] or "Point Blank Range Accuracy: ", GetPBbonus_display(self) or 0, "%"},
  ...
  {TranslationTable[258395588915] or "Snapshot Penalty Multiplier: ", GetSnapshot_mul(self) or 0, "X"}, {
			(self.owner and (TranslationTable[151451884832] or "Recoil Penalty Multiplier: ")) or
								(TranslationTable[896979362710] or "Minimum Recoil Multiplier: "), GetRecoil_mul(self) or 0, "X"}, {
