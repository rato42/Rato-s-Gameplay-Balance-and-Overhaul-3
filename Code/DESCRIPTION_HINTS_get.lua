function rat_format_hints(self)
	local formattedString = "<style CrosshairAPTotal>"
	  ...
	  local termList = {
		{TranslationTable[242435461626] or "Shooting Stance Cost: ", GetAPStance_display(self) or 0, " AP"},
		...
		{TranslationTable[651371401489] or "Point Blank Range Modifier: ", GetPBbonus_display(self) or 0, "%"},
		{TranslationTable[852084205321] or "Hipfire Penalty Multiplier: ", GetHipfire_mul(self) or 0, "X"},
		{TranslationTable[258395588915] or "Snapshot Penalty Multiplier: ", GetSnapshot_mul(self) or 0, "X"},
		{(self.owner and (TranslationTable[151451884832] or "Recoil Penalty Multiplier: ")) or (TranslationTable[896979362710] or "Minimum Recoil Multiplier: "),
		GetRecoil_mul(self) or 0,
		"X"
		},
		{TranslationTable[158466723759] or "Recommended Strength: ", GetSTR_RECOIL(self), (TranslationTable[785975283217]) or " STR"}
	  }
  ...
  local t_id_table ={
	...
	[651371401489] = "Point Blank Range Modifier: ",
