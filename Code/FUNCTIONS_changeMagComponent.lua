...
function rat_changeMag_component(unit)
	...
	-- end
    local weapons_list = {
        {"HiPower", "MagLarge_1", "MagLargeFine_1"},
        {"RPK74", "MagLarge_2", "MagLargeFine_2"},
        {"Glock18", "MagLarge_3", "MagLargeFine_3"},
        {"UZI", "MagLarge_4", "MagLargeFine_4"},
        {"MP5", "MagLarge_5", "MagLargeFine_5"},
        {"MP5K", "MagLarge_5", "MagLargeFine_5"},
        {"M14SAW", "MagLarge_5", "MagLargeFine_5"},
        {"M14SAW_AUTO", "MagLarge_5", "MagLargeFine_5"},
        {"BarretM82", "MagLarge_5", "MagLargeFine_5"},
        {"AA12", "MagLarge_6", "MagLargeFine_6"},
        {"AUG", "MagLarge_7", "MagLargeFine_7"},
        {"HK21", "MagLarge_8", "MagLargeFine_8"},
        {"G36", "MagLarge_9", "MagLargeFine_9"},
        {"PSG1", "MagLarge_10", "MagLargeFine_10"},
        {"MP40", "MagLarge_11", "MagLargeFine_11"},
        {"FNMinimi", "MagLarge_12", "MagLargeFine_12"},
    }
