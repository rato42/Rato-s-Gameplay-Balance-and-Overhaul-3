function aim_cth()
    ...
    Presets.ChanceToHitModifier.Default["Aim"].CalcValue = function(self, attacker, target, body_part_def, action,
        ...
        for _, effect in ipairs(componentEffects) do
            modifyVal, compDef = GetComponentEffectValue(weapon1, effect.effectKey, effect.valueKey)
