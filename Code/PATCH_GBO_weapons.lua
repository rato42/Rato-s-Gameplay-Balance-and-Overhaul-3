...
function RatoGBO_WepPatch()
    ...
    AUG.ComponentSlots = {
        {
            ...
            Modifiable = true,
            AvailableComponents = {
                'BarrelNormal', 'BarrelShort_AUG', 'BarrelShortImproved_AUG', 'BarrelLong_AUG',
                'BarrelLongImproved_AUG', 'BarrelLight', 'long_barrel_AUG_light'
            }
        }, {
            CanBeEmpty = false,
            SlotType = 'Muzzle',
 ...
 <image UI/Conversation/T_Dialogue_IconBackgroundCircle.tga 400 130 128 120> Special firing mode: Double Barrel]]
    ...
    DoubleBarrelShotgun.AimAccuracy = 3
    ...
    FAMAS.ComponentSlots = {
        ...
        {CanBeEmpty = true, SlotType = 'Bipod', Modifiable = true, AvailableComponents = {'Bipod'}},
        {
            ...
            Modifiable = true,
            AvailableComponents = {
                'ReflexSight', 'ScopeCOGQuick', 'ScopeCOG', '_ReflexSIghtVigilance',
 ...
 <image UI/Conversation/T_Dialogue_IconBackgroundCircle.tga 400 130 128 120> In-built bottle opener]]
    ...
    Glock18.AvailableAttacks = {
        "BurstFire", "SingleShot", "DualShot", "CancelShot", "MobileShot", "RunAndGun", "AutoFire"
    }
 ...
 <image UI/Conversation/T_Dialogue_IconBackgroundCircle.tga 400 130 128 120> Has a big recoil penalty]]
    ...
    M16A2.ComponentSlots = {
        {CanBeEmpty = true, SlotType = 'Handguard', Modifiable = false, AvailableComponents = {}},
        {
            ...
            Modifiable = true,
            AvailableComponents = {
                'ScopeCOG', 'ScopeCOGQuick', 'LROptics', 'ThermalScope', 'ReflexSight', 'WideScope',
